...
class DemandeId:
    ...
    def __post_init__(self):
        ...
        try:
            ...
            raise ValueError(f"L'ID de la demande doit être un UUID valide: {self.valeur}")
...
class StatutValidation:
    ...
    def __str__(self) -> str:
        ...
        return f"{status} {self.nom_etape}: {self.message}" if self.message else f"{status} {self.nom_etape}" 