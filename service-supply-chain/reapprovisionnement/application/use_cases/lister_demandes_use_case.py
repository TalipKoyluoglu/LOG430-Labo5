        ...
        try:
            ...
            statistiques = {
                ...
                'pourcentage_important': round(
                    (quantites_importantes / len(demandes_enrichies) * 100) if demandes_enrichies else 0, 2
                )
            }
            
            logger.info(f"Use Case réussi: {len(demandes_enrichies)} demandes récupérées")
