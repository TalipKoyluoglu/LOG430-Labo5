...
class DemandeId:
    ...
    def __post_init__(self):
        ...
        try:
            ...
            raise InventaireDomainError(f"DemandeId '{self.value}' n'est pas un UUID valide")
...
class Quantite:
    ...
    def __post_init__(self):
        ...
        if self.value > 10000:
            raise QuantiteInvalideError("La quantité ne peut pas dépasser 10 000 unités")
...
class SeuilStock:
    ...
    def __post_init__(self):
        ...
        if self.seuil_reapprovisionnement < 0:
            raise InventaireDomainError("Le seuil de réapprovisionnement ne peut pas être négatif")
