...
from ..application.use_cases.gerer_stock_use_case import (
    GererStockUseCase, AugmenterStockRequest, DiminuerStockRequest
)
from ..application.use_cases.gerer_demandes_use_case import (
    GererDemandesUseCase, CreerDemandeRequest
)
...
@swagger_auto_schema(
    ...
    request_body=openapi.Schema(
        ...
        properties={
            ...
            'quantite': openapi.Schema(type=openapi.TYPE_INTEGER, description='Quantité à ajouter'),
            'magasin_id': openapi.Schema(type=openapi.TYPE_INTEGER, description='ID du magasin (optionnel pour stock central)')
        },
...
@swagger_auto_schema(
    ...
    request_body=openapi.Schema(
        ...
        properties={
            'produit_id': openapi.Schema(type=openapi.TYPE_INTEGER, description='ID du produit'),
            'quantite': openapi.Schema(type=openapi.TYPE_INTEGER, description='Quantité à retirer'),
            'magasin_id': openapi.Schema(type=openapi.TYPE_INTEGER, description='ID du magasin (optionnel pour stock central)')
        },
        required=['produit_id', 'quantite']
    ),
...
@swagger_auto_schema(
    ...
    responses={200: "Informations du stock local", 400: "Produit ou magasin non trouvé"}
)
@api_view(['GET'])
...
@swagger_auto_schema(
    ...
    request_body=openapi.Schema(
        type=openapi.TYPE_OBJECT,
        properties={
            'produit_id': openapi.Schema(type=openapi.TYPE_STRING, description='UUID du produit'),
            'magasin_id': openapi.Schema(type=openapi.TYPE_STRING, description='UUID du magasin'),
            'quantite': openapi.Schema(type=openapi.TYPE_INTEGER, description='Quantité demandée')
        },
...
@swagger_auto_schema(
    ...
    responses={200: "Demande approuvée", 400: "Impossible d'approuver", 404: "Demande non trouvée"}
)
@csrf_exempt
...
@swagger_auto_schema(
    ...
    responses={200: "Demande rejetée", 400: "Impossible de rejeter", 404: "Demande non trouvée"}
)
@csrf_exempt
@require_http_methods(["PUT"])
