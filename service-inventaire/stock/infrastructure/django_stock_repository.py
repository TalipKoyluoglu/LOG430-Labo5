...
class DjangoStockRepository(StockRepository):
    ...
    def get_stock_central_by_produit(self, produit_id: ProduitId) -> Optional[StockCentral]:
    ...
    def get_stock_local_by_produit_magasin(self, produit_id: ProduitId, magasin_id: MagasinId) -> Optional[StockLocal]:
    ...
    def get_all_stocks_centraux(self) -> List[StockCentral]:
        ...
        return [self._mapper_stock_central_vers_domaine(stock) for stock in django_stocks]
    
    def get_all_stocks_locaux_by_magasin(self, magasin_id: MagasinId) -> List[StockLocal]:
    ...
    def get_stocks_locaux_faibles(self, magasin_id: MagasinId, seuil: int = 5) -> List[StockLocal]:
    ...
    def save_stock_central(self, stock: StockCentral) -> StockCentral:
        ...
        try:
            ...
            django_stock = DjangoStockCentral.objects.get(produit_id=str(stock.produit_id))
    ...
    def _mapper_stock_central_vers_domaine(self, django_stock: DjangoStockCentral) -> StockCentral:
    ...
    def _mapper_stock_local_vers_domaine(self, django_stock: DjangoStockLocal) -> StockLocal:
