...
class ModifierQuantitePanierUseCase:
    ...
    def execute(
        ...
        logger.info(f"Modification quantité produit {produit_id} dans panier client {client_id}")
        ...
        if not self._stock_service.verifier_stock_disponible(produit_id, nouvelle_quantite):
        ...
        logger.info(f"Quantité produit {produit_id} modifiée: {ancienne_quantite} -> {nouvelle_quantite}")
