...
from ..application.use_cases.ajouter_produit_panier_use_case import AjouterProduitPanierUseCase
from ..application.use_cases.voir_panier_use_case import VoirPanierUseCase
from ..application.use_cases.modifier_quantite_panier_use_case import ModifierQuantitePanierUseCase
...
class PanierView(APIView):
    ...
    def get(self, request, client_id):
        ...
        try:
            ...
            client_uuid = client_id if isinstance(client_id, uuid.UUID) else uuid.UUID(client_id)
...
class PanierProduitView(APIView):
    ...
    def put(self, request, client_id, produit_id):
        ...
        try:
            ...
            client_uuid = client_id if isinstance(client_id, uuid.UUID) else uuid.UUID(client_id)
            produit_uuid = produit_id if isinstance(produit_id, uuid.UUID) else uuid.UUID(produit_id)
