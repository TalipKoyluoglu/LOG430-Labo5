...
urlpatterns = [
    # API Panier complet
    path('clients/<uuid:client_id>/panier/', PanierView.as_view(), name='panier-detail'),
    
    # API Produit spécifique dans le panier
    path('clients/<uuid:client_id>/panier/produits/<uuid:produit_id>/', 
         PanierProduitView.as_view(), name='panier-produit'),
] 