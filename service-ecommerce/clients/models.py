...
class ClientModel(models.Model):
    ...
    # Email unique
    email = models.EmailField(unique=True, validators=[EmailValidator()], help_text="Email unique du client")
    ...
    adresse_province = models.CharField(max_length=50, default="Québec", help_text="Province")
