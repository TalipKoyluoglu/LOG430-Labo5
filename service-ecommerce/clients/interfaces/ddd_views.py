...
from ..application.use_cases.creer_compte_client_use_case import CreerCompteClientUseCase
...
class DDDClientViewSet(viewsets.GenericViewSet):
    ...
    @swagger_auto_schema(
        ...
        request_body=openapi.Schema(
            ...
            required=['prenom', 'nom', 'email', 'adresse_rue', 'adresse_ville', 'adresse_code_postal'],
            properties={
                ...
                'email': openapi.Schema(type=openapi.TYPE_STRING, format=openapi.FORMAT_EMAIL, description='Email unique'),
                'telephone': openapi.Schema(type=openapi.TYPE_STRING, description='Téléphone (optionnel)'),
                'adresse_rue': openapi.Schema(type=openapi.TYPE_STRING, description='Adresse rue'),
                'adresse_ville': openapi.Schema(type=openapi.TYPE_STRING, description='Ville'),
                'adresse_code_postal': openapi.Schema(type=openapi.TYPE_STRING, description='Code postal canadien'),
                'adresse_province': openapi.Schema(type=openapi.TYPE_STRING, description='Province (défaut: Québec)'),
                'adresse_pays': openapi.Schema(type=openapi.TYPE_STRING, description='Pays (défaut: Canada)'),
            }
        ),
        responses={
    ...
    def create(self, request):
        ...
        try:
            ...
            required_fields = ['prenom', 'nom', 'email', 'adresse_rue', 'adresse_ville', 'adresse_code_postal']
            ...
            200: openapi.Response(
                ...
                schema=openapi.Schema(
                    ...
                    items=openapi.Schema(
                        type=openapi.TYPE_OBJECT,
                        properties={
                            'id': openapi.Schema(type=openapi.TYPE_STRING, description='UUID du client'),
                            'nom_complet': openapi.Schema(type=openapi.TYPE_STRING, description='Nom complet du client'),
                            'email': openapi.Schema(type=openapi.TYPE_STRING, description='Email du client'),
                            'telephone': openapi.Schema(type=openapi.TYPE_STRING, description='Téléphone (peut être null)'),
                            'adresse': openapi.Schema(
                                ...
                                properties={
                                    ...
                                    'adresse_complete': openapi.Schema(type=openapi.TYPE_STRING)
                                }
                            ),
                            'date_creation': openapi.Schema(type=openapi.TYPE_STRING, format=openapi.FORMAT_DATETIME),
                            'date_modification': openapi.Schema(type=openapi.TYPE_STRING, format=openapi.FORMAT_DATETIME),
    ...
    def list(self, request):
        ...
        try:
            ...
            logger.error(f"Erreur lors de la récupération de la liste des clients: {str(e)}")
            return Response(
                {"error": "Erreur interne du serveur"},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR
            )
