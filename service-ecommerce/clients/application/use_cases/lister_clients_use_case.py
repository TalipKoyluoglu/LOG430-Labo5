    ...
    def execute(self) -> List[Dict[str, Any]]:
        ...
        for client in clients:
            client_info = {
                ...
                "date_creation": client.date_creation.isoformat() if client.date_creation else None,
                "date_modification": client.date_modification.isoformat() if client.date_modification else None,
                "actif": client.actif
            }
