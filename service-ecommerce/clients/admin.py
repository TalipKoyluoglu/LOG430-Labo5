...
class ClientAdmin(admin.ModelAdmin):
    ...
    """
    list_display = ['nom_complet_display', 'email', 'adresse_ville', 'actif', 'date_creation']
    ...
    fieldsets = (
        ...
        ('Adresse', {
            'fields': ('adresse_rue', 'adresse_ville', 'adresse_code_postal', 'adresse_province', 'adresse_pays')
        }),
        ('Métadonnées', {
