...
class ProcessusCheckoutModel(models.Model):
    ...
    adresse_nom_destinataire = models.CharField(max_length=200, help_text="Nom du destinataire")
    ...
    adresse_instructions = models.TextField(null=True, blank=True, help_text="Instructions de livraison")
    livraison_express = models.BooleanField(default=False, help_text="Livraison express")
...
class CommandeEcommerce(models.Model):
    ...
    def adresse_complete(self):
        return f"{self.rue}, {self.ville}, {self.province} {self.code_postal}, {self.pays}"
