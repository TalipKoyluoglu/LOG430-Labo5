...
from ..models import Vente as VenteDjango, LigneVente as LigneVenteDjango, Magasin as MagasinDjango
...
class DjangoVenteRepository(VenteRepository):
    ...
    def get_by_id(self, vente_id: str) -> Optional[Vente]:
        ...
        try:
            vente_django = VenteDjango.objects.prefetch_related('lignes').get(id=vente_id)
    ...
    def _save_lignes_vente(self, vente_django: VenteDjango, lignes: List[LigneVenteVO]) -> None:
