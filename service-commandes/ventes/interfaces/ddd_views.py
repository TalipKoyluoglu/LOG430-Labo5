...
# Domain Layer
from ..domain.value_objects import CommandeVente, MagasinId, ProduitId, ClientId, StockInfo
from ..domain.exceptions import (
    MagasinInexistantError, ProduitInexistantError,
    StockInsuffisantError, VenteInvalideError, VenteDejaAnnuleeError
)
...
from ..application.use_cases.generer_indicateurs_use_case import GenererIndicateursUseCase
from ..application.use_cases.generer_rapport_consolide_use_case import GenererRapportConsolideUseCase
        ...
        try:
            ...
            for vente in ventes:
                ...
                for ligne in vente.lignes:
                    ...
                    produit_nom = produit_info.nom if produit_info else f"Produit {ligne.produit_id}"
