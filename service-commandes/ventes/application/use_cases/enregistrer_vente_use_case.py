...
class EnregistrerVenteUseCase:
    ...
    def execute(self, commande: CommandeVente) -> Dict[str, Any]:
        ...
        stock_info = self._stock_service.get_stock_local(commande.magasin_id, commande.produit_id)
        if not magasin.peut_vendre(commande.produit_id, commande.quantite, stock_info.quantite_disponible):
