...
class GenererIndicateursUseCase:
    ...
    def _calculer_tendances(self, magasin: Magasin, debut: datetime, fin: datetime) -> str:
        """
        ...
        for vente in ventes_periode:
            for ligne in vente.lignes:
                ...
                if produit_id not in produits_noms:
                    ...
                    produits_noms[produit_id] = produit_info.nom if produit_info else f"Produit {produit_id}"
