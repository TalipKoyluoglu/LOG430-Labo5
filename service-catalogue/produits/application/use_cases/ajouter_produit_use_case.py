...
from ...domain.value_objects import CommandeProduitSimple, NomProduit, PrixMonetaire, CategorieId
...
class AjouterProduitUseCase:
    ...
    def _produit_to_dict_simple(self, produit: Produit, nom_categorie: str) -> Dict[str, Any]:
        """
