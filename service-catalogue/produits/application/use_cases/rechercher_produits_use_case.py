...
class RechercherProduitsUseCase:
    ...
    def execute(self, criteres: CritereRecherche) -> Dict[str, Any]:
        ...
        return {
            "produits": [self._produit_to_dict_simple(p) for p in produits_tries]
        }
    ...
    def _appliquer_filtres(self, produits: List[Produit], criteres: CritereRecherche) -> List[Produit]:
        """
        ...
        if criteres.a_filtre_categorie():
            produits_filtres = self._filtrer_par_categorie(produits_filtres, criteres.categorie_id)
    ...
    def _filtrer_par_nom(self, produits: List[Produit], terme_recherche: str) -> List[Produit]:
        """
    ...
    def _filtrer_par_categorie(self, produits: List[Produit], categorie_id: CategorieId) -> List[Produit]:
        """
    ...
    def _filtrer_par_prix(self, produits: List[Produit], prix_min: Decimal, prix_max: Decimal) -> List[Produit]:
        """
    ...
    def _prix_dans_fourchette(self, prix: Decimal, prix_min: Decimal, prix_max: Decimal) -> bool:
        """
    ...
    def _calculer_pertinence_et_trier(self, produits: List[Produit], criteres: CritereRecherche) -> List[Produit]:
        """
    ...
    def _generer_metadonnees(self, produits: List[Produit], criteres: CritereRecherche) -> Dict[str, Any]:
        """
    ...
    def _criteres_to_dict(self, criteres: CritereRecherche) -> Dict[str, Any]:
        ...
        return {
            "nom": criteres.nom,
            "categorie_id": str(criteres.categorie_id) if criteres.categorie_id else None,
