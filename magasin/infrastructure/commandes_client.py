...
class CommandesClient:
    ...
    def enregistrer_vente(self, 
        ...
        try:
            ...
            response = self.session.post(
                f"{self.base_url}/api/v1/ventes-ddd/enregistrer/",
                json=data
            )
    ...
    def annuler_vente(self, vente_id: str, motif: str) -> Dict[str, Any]:
        ...
        try:
            ...
            response = self.session.patch(
                f"{self.base_url}/api/v1/ventes-ddd/{vente_id}/annuler/",
                json=data
            )
            response.raise_for_status()
            return response.json()
    ...
    def consulter_vente(self, vente_id: str) -> Dict[str, Any]:
        ...
        """
        try:
            response = self.session.get(f"{self.base_url}/api/v1/ventes-ddd/{vente_id}/")
            response.raise_for_status()
            return response.json()
        ...
        try:
            ...
            if toutes_ventes.get('success', False):
                ...
                ventes_magasin = [
                    ...
                    if vente.get('magasin_id') == magasin_id
                ]
    ...
    def obtenir_statistiques_ventes(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'chiffre_affaires_actif': sum(v.get('total', 0) for v in ventes_actives)
            }
