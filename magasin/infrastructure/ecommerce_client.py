...
class EcommerceClient:
    ...
    def creer_compte_client(self, prenom: str, nom: str, email: str, 
                           adresse_rue: str, adresse_ville: str, adresse_code_postal: str,
                           telephone: Optional[str] = None,
                           adresse_province: str = "Québec",
                           adresse_pays: str = "Canada") -> Dict[str, Any]:
        """
        POST /api/clients/
    ...
    def valider_client(self, client_id: str) -> Dict[str, Any]:
        ...
        """
        try:
            response = self.session.get(f"{self.base_url}/api/clients/{client_id}/valider/")
            response.raise_for_status()
            return response.json()
    ...
    def voir_panier(self, client_id: str) -> Dict[str, Any]:
        ...
        """
        try:
            response = self.session.get(f"{self.base_url}/api/panier/clients/{client_id}/panier/")
            response.raise_for_status()
            return response.json()
    ...
    def ajouter_produit_panier(self, client_id: str, produit_id: str, quantite: int) -> Dict[str, Any]:
        """
    ...
    def vider_panier(self, client_id: str) -> Dict[str, Any]:
        ...
        """
        try:
            response = self.session.delete(f"{self.base_url}/api/panier/clients/{client_id}/panier/")
            response.raise_for_status()
            return response.json()
    ...
    def modifier_quantite_panier(self, client_id: str, produit_id: str, quantite: int) -> Dict[str, Any]:
        """
    ...
    def checkout_ecommerce(self, client_id: str, adresse_livraison: Optional[Dict] = None, 
    ...
    def verifier_prerequis_checkout(self, client_id: str) -> Dict[str, Any]:
        ...
        """
        try:
            response = self.session.get(f"{self.base_url}/api/commandes/clients/{client_id}/checkout/prerequis/")
            response.raise_for_status()
            return response.json()
    ...
    def historique_commandes_client(self, client_id: str) -> Dict[str, Any]:
        ...
        """
        try:
            response = self.session.get(f"{self.base_url}/api/commandes/clients/{client_id}/historique/")
            response.raise_for_status()
            return response.json()
