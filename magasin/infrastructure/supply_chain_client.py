...
class SupplyChainClient:
    ...
    def lister_demandes_en_attente(self) -> Dict[str, Any]:
        ...
        """
        try:
            response = self.session.get(f"{self.base_url}/api/ddd/supply-chain/demandes-en-attente/")
    ...
    def valider_demande(self, demande_id: str) -> Dict[str, Any]:
        ...
        """
        try:
            response = self.session.post(f"{self.base_url}/api/ddd/supply-chain/valider-demande/{demande_id}/")
            response.raise_for_status()
            return response.json()
    ...
    def obtenir_statistiques_workflow(self) -> Dict[str, Any]:
        ...
        try:
            ...
            demandes_importantes = [d for d in demandes if d.get('est_quantite_importante', False)]
            ...
            for demande in demandes:
                ...
                if produit_id:
                    ...
                    produits_demandes[produit_id]['quantite_totale'] += demande.get('quantite', 0)
