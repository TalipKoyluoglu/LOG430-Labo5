...
class InventaireClient:
    ...
    def health_check(self) -> Dict[str, Any]:
        ...
        """
        try:
            response = self.session.get(f"{self.base_url}/api/ddd/inventaire/health-check/")
    ...
    def augmenter_stock(self, produit_id: int, quantite: int, magasin_id: Optional[int] = None) -> Dict[str, Any]:
        """
    ...
    def diminuer_stock(self, produit_id: int, quantite: int, magasin_id: Optional[int] = None) -> Dict[str, Any]:
        """
    ...
    def consulter_stock_central(self, produit_id: int) -> Dict[str, Any]:
        ...
        """
        try:
            response = self.session.get(f"{self.base_url}/api/ddd/inventaire/stock-central/{produit_id}/")
            response.raise_for_status()
            return response.json()
    ...
    def consulter_stock_local(self, produit_id: int, magasin_id: int) -> Dict[str, Any]:
        ...
        """
        try:
            response = self.session.get(f"{self.base_url}/api/ddd/inventaire/stock-local/{produit_id}/{magasin_id}/")
            response.raise_for_status()
            return response.json()
            
        except requests.exceptions.RequestException as e:
            logger.error(f"Erreur consultation stock local {produit_id}/{magasin_id}: {e}")
            return {"success": False, "error": str(e)}
    ...
    def lister_stocks_centraux(self) -> Dict[str, Any]:
        ...
        """
        try:
            response = self.session.get(f"{self.base_url}/api/ddd/inventaire/stocks-centraux/")
            response.raise_for_status()
            data = response.json()
    ...
    def lister_stocks_locaux_magasin(self, magasin_id: int) -> Dict[str, Any]:
        ...
        """
        try:
            response = self.session.get(f"{self.base_url}/api/ddd/inventaire/stocks-locaux/{magasin_id}/")
            response.raise_for_status()
            return response.json()
    ...
    def lister_tous_magasins_avec_stocks(self) -> Dict[str, Any]:
        ...
        """
        try:
            response = self.session.get(f"{self.base_url}/api/ddd/inventaire/tous-magasins-stocks/")
            response.raise_for_status()
            return response.json()
    ...
    def lister_demandes_en_attente(self) -> Dict[str, Any]:
        ...
        """
        try:
            response = self.session.get(f"{self.base_url}/api/ddd/inventaire/demandes/en-attente/")
            response.raise_for_status()
            return response.json()
    ...
    def lister_demandes_par_magasin(self, magasin_id: int) -> Dict[str, Any]:
        ...
        """
        try:
            response = self.session.get(f"{self.base_url}/api/ddd/inventaire/demandes/magasin/{magasin_id}/")
            response.raise_for_status()
            return response.json()
    ...
    def obtenir_demande_par_id(self, demande_id: str) -> Dict[str, Any]:
        ...
        """
        try:
            response = self.session.get(f"{self.base_url}/api/ddd/inventaire/demandes/{demande_id}/")
            response.raise_for_status()
            return response.json()
    ...
    def supprimer_demande(self, demande_id: str) -> Dict[str, Any]:
        ...
        """
        try:
            response = self.session.delete(f"{self.base_url}/api/ddd/inventaire/demandes/{demande_id}/")
            response.raise_for_status()
            return response.json()
    ...
    def approuver_demande(self, demande_id: str) -> Dict[str, Any]:
        ...
        """
        try:
            response = self.session.put(f"{self.base_url}/api/ddd/inventaire/demandes/{demande_id}/approuver/")
            response.raise_for_status()
            return response.json()
    ...
    def rejeter_demande(self, demande_id: str) -> Dict[str, Any]:
        ...
        """
        try:
            response = self.session.put(f"{self.base_url}/api/ddd/inventaire/demandes/{demande_id}/rejeter/")
            response.raise_for_status()
            return response.json()
    ...
    def analyser_besoins_reapprovisionnement(self, magasin_id: int) -> Dict[str, Any]:
        ...
        """
        try:
            response = self.session.get(f"{self.base_url}/api/ddd/inventaire/analyser-besoins/{magasin_id}/")
            response.raise_for_status()
            return response.json()
